...
<body>
	...
	<s:form action="/multiUploadFile" enctype="multipart/form-data" namespace="/upload" >
            <s:file name="uploads" multiple="multiple" />
            <s:submit value="Upload files" />
        </s:form>
	
	<%-- <s:form method="POST" enctype="multipart/form-data" action="multiUploadFile" id="uploaddocumentfile" namespace="/upload" >
