		...
		<div class="container">
			<div class="row">
				<div class="col-sm-9 col-sm-offset-3">
					...
					<%-- <s:else>
							<tr>
								<td><span>I affirm that I have not uploaded evidence
										for the judge to consider. I understand that this was the only
										opportunity I could upload evidence for my hearing.</span></td>
							</tr>
						</s:else> --%>
					<br>
					...
					<div>
						...
						&nbsp;&nbsp;&nbsp; <input type="button"
							...
							onclick="window.location='ticket/broker_selection.jsp'">
					</div>
